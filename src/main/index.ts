...
import {  getCards } from './cardsManager';
// import { initHandlers } from "./ipcHandler";
...
// bypass cssp since localhost uses http:/
...
const createWindow = (): void => {
  ...
  ipcMain.handle("getCards", getCards)
  ...
  //       'Content-Security-Policy': ["script-src 'self' https://gatherer.wizards.com"]
  //     }
  //   })
  // })
